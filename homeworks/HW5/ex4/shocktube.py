...
hs = ulula_sim.HydroScheme(reconstruction = 'linear', limiter = 'mc', riemann='hll', time_integration='hancock_cons', cfl = 0.8) 
...
ulula_plt.plot1d(sim, q_plot=q_plot, plot_type='line', idir_func=line_dir, true_solution_func=true_solu) 
plt.savefig("shocktube_mc_linear_hancock_cons.png")
